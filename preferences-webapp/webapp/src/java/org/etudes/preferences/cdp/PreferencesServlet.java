/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/preferences/trunk/preferences-webapp/webapp/src/java/org/etudes/preferences/cdp/PreferencesServlet.java $
 * $Id: PreferencesServlet.java 5240 2013-06-21 20:21:08Z ggolden $
 ***********************************************************************************
 *
...
{
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(PreferencesServlet.class);
	...
	public void init(ServletConfig config) throws ServletException
	{
		...
		final CdpHandler handler = new PreferencesCdpHandler();
